<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @guest
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-gray-900 px-4 py-2">Login</a>
                <a href="{{ route('register') }}" class="ml-2 text-sm text-gray-600 hover:text-gray-900 px-4 py-2">Registrar</a>
            </div>
            @endguest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ optional(Auth::user())->name ?? 'Visitante' }}</div>
